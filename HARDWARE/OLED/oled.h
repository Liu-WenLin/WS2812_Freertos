...
#define OLED_SCL_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_1)//SCL
#define OLED_SCL_Set() GPIO_SetBits(GPIOC,GPIO_Pin_1)
...
void Partial_OLED_Clear(u8 Start_x,u8 End_x,u8 Start_y,u8 End_y);
